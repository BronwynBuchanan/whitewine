...
title("Fixed Acidity and Quality Residual Histogram")
...
title("Volatile Acidity and Quality Residual Histogram")
...
title("Citric Acid and Quality Residual Histogram") 
...
title("pH and Quality Residual Histogram") 
...
title("Sulphates and Quality Residual Histogram")
...
title("Free Sulfur Dioxide and Quality Residual Histogram")
...
title("Total Sulfur Dioxide and Quality Residual Histogram")
...
title("Residual Sugar and Quality Residual Histogram")
...
title("Chlorides and Quality Residual Histogram")
...
title("Alcohol and Quality Residual Histogram")
...
title("Density and Quality Residual Histogram")
...
table(predicted = whiteordinal_predictions, actual = whitetrain$quality)  
#Confusion Matrix Test 
cm2 = table(predicted = whiteordinal_predictions, actual = whitetrain$quality) 
cm2 
#Our model performs better on our training data than our baseline model. This makes sense as it predicts the "good" class (2) very often. 
